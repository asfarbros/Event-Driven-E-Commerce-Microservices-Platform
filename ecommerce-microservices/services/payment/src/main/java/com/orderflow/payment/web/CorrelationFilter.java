 ...
 *       {@code userId} for the logs. Informational: POST /payments is a
 *       server-to-server call from Order Service, and the webhook comes from
 *       Razorpay — neither carries a user session.</li>
